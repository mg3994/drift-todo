...
import 'package:findhere/database/database.steps.dart';
...
class AppDatabase extends _$AppDatabase {
  ...
  Future<void> backup() async {
    await createDatabaseBackup(this);
  }
  ...
  Future<void> restore() async {
    ...
    // Note: Re-opening the database should be done by the UI or calling code
    // by replacing the signal value.
  }
...
Future<void> createDatabaseBackup(AppDatabase db) async {
